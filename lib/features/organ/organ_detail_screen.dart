    ...
    return Scaffold(
      ...
      body: BlocBuilder<OrganCubit, OrganState>(
        builder: (context, state) {
          ...
          // Recommendation card height varies with copy/chips; risk section must
          // follow it in flow layout (fixed Y caused the risk heading to sit on
          // top of Strengths / Weakness).
          final designHeight =
              (869 + 1100 + organ.riskMetrics.length * 80.0 + 80).clamp(2200.0, 3600.0);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < organ.riskMetrics.length; i++) ...[
                      ...
                      if (i < organ.riskMetrics.length - 1) const SizedBox(height: 12),
                    ],
